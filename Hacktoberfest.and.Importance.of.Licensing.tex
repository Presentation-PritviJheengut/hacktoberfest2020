...
\title{Hacktoberfest and Licensing}
...
\date[Hacktoberfest and Licensing]{Hacktoberfest - 23 October 2020}
...
\section{Tribute to Dennis Ritchie}
...
\section{Welcome to Hacktoberfest}
\frame{
...
\section{Free/Libre and Open Source Software}
...
\section{repository/Project and licensing}
\frame{
  \frametitle{Starting a project}

  \huge

  Starting a project and releasing your project to the
  public as a new repository on github.

  You are not forced to adopt free/libre or open source idealogies.
...
\frame{
  ...
  Almost three decades ago, Linus Torvalds released the
  Linux Kernel under the GPL.  

  
  Huge project with millions of lines of codes, several
  thousands of developers send an ever increasing number
  of patches per day
  }
...
\frame{
  ...
  Github was acquired by and is now subsidiary a Microsoft
...
\frame{
  \frametitle{GitHub and Licensing your project}

  \huge

  How to add a license when creating a new github repository.
...
\frame{
  ...
  Kudos to Digital Ocean and partners for organising this festival.
  }
